...
const Footer = (): ReactElement => {
  return (
    <footer id="footer" className="footer">
      <p className="copyright-desktop">© {new Date().getFullYear()} Pascal Allen & Crimson Drive Design LLC</p>
      <p className="copyright-mobile">© {new Date().getFullYear()} Pascal Allen & CDD LLC</p>
